...
//        System.out.println(companyEntities);
        List<CirculateDistributorDetailEntity> list = new ArrayList<>();
        for (int i = 0; i < jsonArray.size(); i++) {
            ...
            CirculateDistributorDetailEntity distributorDetailEntity = JSON.toJavaObject(object, CirculateDistributorDetailEntity.class);
